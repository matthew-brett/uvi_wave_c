function [dlp, dhp] = wt_synth_delay(rh, rg, del1, del2)
% work out delays for synthesis filters
% FORMAT [dlp, dhp] = wt_synth_delay(rh, rg, del1, del2)
% 
% rh     - low pass filter
% rg     - high pass filter
...
% 
% $Id: wt_synth_delay.m,v 1.1 2004/09/26 06:44:50 matthewbrett Exp $
