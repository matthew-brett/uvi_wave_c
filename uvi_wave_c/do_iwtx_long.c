...
/* 
   This version of do_iwtx.c was an attempt at making it faster by
   unrolling the high pass / low pass loop.  Needless to say it didn't
   make the function any faster, but I've kept it, because it works,
   and may be useful later on

   $Id: do_iwtx_long.c,v 1.1 2004/09/26 06:44:50 matthewbrett Exp $
 */
